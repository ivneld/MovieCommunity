package Movie.MovieCommunity.advice;

import Movie.MovieCommunity.advice.error.DefaultAuthenticationException;
import Movie.MovieCommunity.advice.error.DefaultException;
import Movie.MovieCommunity.advice.error.DefaultNullPointerException;
import Movie.MovieCommunity.advice.error.InvalidParameterException;
import Movie.MovieCommunity.advice.payload.ErrorCode;
import Movie.MovieCommunity.advice.payload.ErrorResponse;
