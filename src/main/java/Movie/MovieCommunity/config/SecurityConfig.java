...
//    @Order(SecurityProperties.BASIC_AUTH_ORDER)
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/","/community/**","/heart/**","/posts/**","/api/subcomment/**","/api/posts/**","/postByMovie/**","/postByMember/**","/posts/read/**", "/posts/search/**", "/error","/favicon.ico", "/**/*.png", "/**/*.gif", "/**/*.svg", "/**/*.jpg", "/**/*.html", "/**/*.css", "/**/*.js", "/movie/**", "/genre/**","/comment/**","/credit/**","/tv/**","/gallery/**")
                .permitAll()
